            ...
            <form @submit="onSubmit" action="submit-form.php" method="POST">
                ...
                <div class="form-group-container">
                    ...
                    <div class="form-group form-input-duo">
                        ...
                        <input placeholder="e.g. A" class="form-text-input" v-model="numberAddition" type="number"
                            name="numberAddition" id="numberAddition">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input placeholder="e.g. Utrecht" class="form-text-input" v-model="city" type="text" name="city"
                        id="city">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-container">
                        ...
                        <img class="form-text-icon"
                            src="../../public/Frontend_Internship_Test_Slices/ic_plus_grey@3x.png" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input placeholder="e.g. €150.000" class="form-text-input" v-model="price" type="number" name="price"
                        id="price">
                </div>
                ...
                <div class="form-group-container">
                    <div class="form-group form-input-duo">
                        ...
                        <input placeholder="e.g. 60m2" class="form-text-input" v-model="size" type="number" name="size"
                            id="size">
                    </div>
                ...
                <div class="form-group-container">
                    <div class="form-group form-input-duo">
                        ...
                        <input placeholder="Enter amount" class="form-text-input" v-model="bedrooms" type="number"
                            name="bedrooms" id="bedrooms">
                    </div>

                    <div class="form-group form-input-duo">
                        <label class="form-label" for="bathrooms">Bathrooms*</label>
                        <input placeholder="Enter amount" class="form-text-input" v-model="bathrooms" type="number"
...
export default {
    ...
    methods: {
        async updateHouse(house) {
            try {
            const res = await fetch(`https://api.intern.d-tt.nl/api/houses/${this.id}`, {
                method: 'POST',
                headers: {
    ...
    async created() {
        let houses = await this.fetchHouses();
